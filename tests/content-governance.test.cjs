...
test("Pages uses an explicit learner-file allowlist and excludes governance reports and tests", () => {
  ...
  ["responsible-supply-chain-compliance-foundations", "eco-design-circularity-aerospace-materials", "supply-chain-compliance-decision-review", "ethical-armor", "phytosanitary-defender", "reach-compliance-challenge", "year-15-challenge"].forEach(directory => assert.match(workflow, new RegExp(directory)));
});
