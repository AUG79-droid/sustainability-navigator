(() => {
  ...
  const ui = {
    es: {
      ...
      learningIntentionsIntro: "Elige una intención para ver una selección del catálogo o utiliza los filtros avanzados para explorar los 24 recursos.",
    ...
    en: {
      ...
      learningIntentionsIntro: "Choose an intention to see a catalogue selection, or use advanced filters to explore all 24 resources.",
